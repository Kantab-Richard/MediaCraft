          ...
          <div className="flex min-h-screen flex-col items-center justify-center py-20">
            ...
            <div className="relative z-10 flex w-full flex-col items-center gap-16 px-4">
              ...
              >
                ...
                >
                  Start with downloading from YouTube, Instagram, TikTok, and
                  more, then turn each asset into clips, transcripts,
                  summaries, and workspace-ready outputs.
                  <span className="hidden sm:inline">
                    {" "}
                    MediCraft is now shaped like a broader creator operations
                    platform.
                  </span>
                </motion.p>
              </motion.div>
              ...
              >
                ...
                <Link
                  href="/workspace"
                  className="inline-flex h-11 items-center justify-center rounded-full border border-border/70 bg-background/70 px-5 text-sm font-medium text-foreground transition-colors hover:bg-background"
                >
                  Explore Workspace
                </Link>
                <div className="rounded-full border border-border/60 bg-background/50 px-4 py-2 text-sm text-foreground/60">
                  Download + transform + organize + publish
                </div>
              </motion.div>
