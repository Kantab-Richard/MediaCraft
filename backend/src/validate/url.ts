...
export const isFacebookUrl = (url: string) => {
  try {
    ...
    const validDomains = ['facebook.com', 'www.facebook.com', 'web.facebook.com', 'm.facebook.com', 'fb.watch'];
    ...
    const validPaths = [
      ...
      '/story',
      '/groups',
      '/share/v', // Desktop Video Shares
      '/share/r', // Mobile Reel Shares
      '/share/p', // Post/Permalink Shares
      '/permalink.php', // Legacy permanent links
      '/video.php', // Legacy video IDs
    ];
    const path = urlObj.pathname.toLowerCase();
...
export const isPinterestUrl = (url: string) => {
  try {
    ...
    const validDomains = ['pinterest.com', 'www.pinterest.com', 'pin.it'];
...
export const isTwitterUrl = (url: string) => {
  try {
    ...
    const validDomains = ['twitter.com', 'www.twitter.com', 'mobile.twitter.com', 'x.com', 'www.x.com'];
